...
# Network
parser.add_argument('--network', type=str, default='LResNet50E_IR',
...
parser.add_argument('--classifier_type', type=str, default='Arcface',
                    help='Which classifier for train. (Cosface, Sphereface, Softmax, Arcface)')
# LR policy
...
if args.database is 'WebFace':
    args.train_list = '/home/dff/f/sphereface/train/data/CASIA-WebFace-112X96.txt'
...
def main():
    ...
    classifier = {
        'Cosface': layer.MarginCosineProduct(512, args.num_class).to(device),
        'Sphereface' : layer.AngleLinear(512, args.num_class).to(device),
        'Softmax'  : torch.nn.Linear(512, args.num_class, bias=False).to(device),
        'Arcface' : layer.ArcMarginProduct(512, args.num_class).to(device),
